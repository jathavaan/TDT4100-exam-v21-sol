...
public class Person {
	...
	public void setStreetNumber(int streetNumber) {
		if (streetNumber < 0)
			throw new IllegalArgumentException("Gatenummer må være et positivt heltall");
	...
	public static void main(String[] args) {
		...
		System.out.println(person.getStreetName() + " " + person.getStreetNumber());
		person.setStreetName("Test2");
		person.setStreetNumber(23);
		System.out.println(person.getStreetName() + " " + person.getStreetNumber());
	}
}
